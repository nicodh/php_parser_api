...
class Tx_Classparser_ViewHelpers_MethodViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractViewHelper {
				...
				if ($parameter->isOptional()) {
					...
					if (is_array($defaultValue)) {
						if (!empty($defaultValue)) {
							...
							$defaultValue = Tx_Classparser_Utility_Tools::convertJSONArrayToPHPArray($defaultValue);
