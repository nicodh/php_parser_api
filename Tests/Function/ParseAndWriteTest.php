...
class Tx_Classparser_Tests_Function_ParseAndWriteTest extends Tx_Classparser_Tests_Parser_ParserTest {
	...
	function parseAndWriteSimpleNamespace() {
		...
		$this->assertEquals($classFileObject->getFirstClass()->getNameSpace(), '\\Test\\Model');
	}
